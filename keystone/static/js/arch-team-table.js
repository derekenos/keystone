import{i as e,_ as t,e as a,y as r,a as s}from"./chunk-query-assigned-elements.js";import{t as o}from"./chunk-state.js";import{U as i,t as n}from"./chunk-helpers.js";import{T as l}from"./chunk-pubsub.js";import{A as d}from"./chunk-arch-data-table.js";import{i as m}from"./chunk-focusable.js";import{A as c}from"./chunk-ArchAPI.js";import{A as h}from"./chunk-arch-modal.js";import{B as p,g as u}from"./chunk-styles.js";import{A as b}from"./chunk-arch-select-adder.js";import"./arch-loading-indicator.js";import"./arch-hover-tooltip.js";import"./chunk-scale-large.js";import"./chunk-sp-overlay.js";import"./chunk-sizedMixin.js";var f=[...h.styles,p,e`
    form > label {
      font-weight: normal;
      margin-top: 0.5rem;
      font-size: 0.95rem;
  ...
  `];let y=class extends h{set unhandledError(e){const{errorEl:t}=this;e?t.classList.add("show"):t.classList.remove("show")}connectedCallback(){super.connectedCallback(),this.scrollable=!0,this.modalSize="m",this.title="Create a New Team",this.submitButtonText="Create",this.content=r`
    ...
    `,this.addEventListener("sp-closed",this.onCloseHandler.bind(this))}submit(e){e&&(e.preventDefault(),e.stopPropagation());const{form:t}=this;if(!t.checkValidity())return void t.reportValidity();const a=new FormData(this.form),r={account_id:parseInt(a.get("account-id")),name:a.get("name")};this.createTeam(r)}clearErrors(){this.unhandledError=!1,this.form&&this.nameInput.setCustomValidity("")}clearInputValidityOnChange(e){const t=()=>{e.setCustomValidity(""),e.removeEventListener("input",t)};e.addEventListener("input",t)}createTeam(e){this.clearErrors(),c.teams.create(e).then((()=>{this.open=!1,this.onCreate()})).catch((e=>{var t;400!==(null===(t=e.response)||void 0===t?void 0:t.status)?this.unhandledError=!0:e.response.json().then((e=>{const{details:t}=e;let a=!0;t.endsWith("already exists for fields ('lower(name::text)', 'account_id')")&&(this.nameInput.setCustomValidity("A team with this name already exists."),this.nameInput.reportValidity(),this.clearInputValidityOnChange(this.nameInput),a=!1),this.unhandledError=a})).catch((()=>{this.unhandledError=!0}))}))}onCloseHandler(){var e;null===(e=this.form)||void 0===e||e.reset(),this.clearErrors()}};y.styles=f,t([a({type:Number})],y.prototype,"accountId",void 0),t([a()],y.prototype,"onCreate",void 0),t([m("form")],y.prototype,"form",void 0),t([m("form > input#name")],y.prototype,"nameInput",void 0),t([m("div.error")],y.prototype,"errorEl",void 0),y=t([s("arch-create-new-team-modal")],y);var g=[u,e`
    h3 {
  ...
  `];let w=class extends h{constructor(){super(),this.onUpdate=e=>null,this.accountUsers=[],c.users.list().then((e=>this.accountUsers=e.items))}set unhandledError(e){const{errorEl:t}=this;e?t.classList.add("show"):t.classList.remove("show")}set team(e){const{accountUsers:t}=this;this.content=void 0!==e?r`
      <form @submit=${this.submit} validate>
    ...
    `:r``}connectedCallback(){super.connectedCallback(),this.scrollable=!0,this.modalSize="m",this.submitButtonText="Save",this.title="Edit Team",this.addEventListener("sp-closed",this.onCloseHandler.bind(this))}submit(e){e&&(e.preventDefault(),e.stopPropagation());const{form:t,membersSelector:a}=this;if(!t.checkValidity())return void t.reportValidity();const r=new FormData(this.form),s=parseInt(r.get("id")),o={name:r.get("name"),members:a.selectedOptions};this.updateTeam(s,o)}clearErrors(){this.unhandledError=!1,this.form&&this.nameInput.setCustomValidity("")}clearInputValidityOnChange(e){const t=()=>{e.setCustomValidity(""),e.removeEventListener("input",t)};e.addEventListener("input",t)}updateTeam(e,t){this.clearErrors(),c.teams.update(e,t).then((e=>{this.open=!1;try{this.onUpdate(e)}catch(e){console.error(e)}})).catch((e=>{var t;400!==(null===(t=e.response)||void 0===t?void 0:t.status)?this.unhandledError=!0:e.response.json().then((e=>{const{details:t}=e;t.endsWith("already exists for fields ('lower(name::text)', 'account_id')")?(this.nameInput.setCustomValidity("A team with this name already exists."),this.nameInput.reportValidity(),this.clearInputValidityOnChange(this.nameInput)):this.unhandledError=!0})).catch((()=>this.unhandledError=!0))}))}onCloseHandler(){var e;null===(e=this.form)||void 0===e||e.reset(),this.membersSelector.reset(),this.clearErrors()}};w.styles=T,t([a()],w.prototype,"onUpdate",void 0),t([m("form")],w.prototype,"form",void 0),t([m("form > input#name")],w.prototype,"nameInput",void 0),t([m("div.error")],w.prototype,"errorEl",void 0),t([m("arch-team-members-selector")],w.prototype,"membersSelector",void 0),t([o()],w.prototype,"accountUsers",void 0),w=t([s("arch-edit-team-modal")],w);var E=[e`
    data-table > table {
      table-layout: fixed;
    }
